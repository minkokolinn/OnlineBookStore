...
<section id="center" class="clearfix center_shop" style="background-image: url(image/internationalbook1.jpg); background-position: center; background-size: cover;"> 
 <div class="container">
  <div class="row">
 ...
 <div class="container">
  <div class="row">
		<div class="product_2 clearfix">
			...
			<ul id="myUL">
				<?php 
					$selectbook="SELECT * from book where bookType='International'";
